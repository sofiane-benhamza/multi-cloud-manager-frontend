                        ...
                        <div className="card-body">
                            <div className="d-flex flex-row mb-4">
                                ...
                                <button className="border border-dark rounded d-flex align-items-center ml-auto mr-3 px-3 btn btn-light" onClick={() => {
                                    setFilter((prev) => ({ ...prev, applications: [{ name: wait, id: wait, repository: wait, technology: wait }] }));
                                     getAmplifyApps(token, filter.account, filter.region, setFilter)
                                    ...
                                    <tbody>
                                        {filter.applications.length > 0 ? (filter.applications.map((application, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="text-center" title={application.repository} ><button disabled={application.id == "-"} className="btn btn-dark"><a href={application.repository} className="bi bi-box-arrow-up-right" target="_blank"></a></button></td>
                                                <td className="text-center" title={application.defaultDomain} ><button disabled={application.id == "-"} className="btn btn-dark"><a href={"https://" + application.defaultDomain} className="bi bi-box-arrow-up-right" target="_blank"></a></button></td>
