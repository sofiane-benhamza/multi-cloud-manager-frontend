...
export default function AWS() {
                ...
                <Link href={`/home/aws/${url}`} passHref>
                    <CardHeader className="justify-between">
                        <div className="d-flex text-dark font-weight-bold flex-row justify-content-left align-items-center gap-5">
                            ...
                            {url && <h4 class="badge badge-success ml-auto" style={{fontSize:"1.2rem"}}><i class="bi bi-check-circle-fill"></i></h4>}
    ...
    return (<>
        ...
        <div className="d-flex row w-100 justify-content-center text-dark">
            ...
            {AwsService("Security Groups","https://res.cloudinary.com/hy4kyit2a/f_auto,fl_lossy,q_70/learn/modules/aws-cloud-security/learn-about-aws-security-services/images/8d03a75da1004ae7489a19260cb70889_84-e-710-e-4-cd-3-b-4301-9744-07-fcc-43-b-059-a.png","securityGroups")}
            ...
            {AwsService("Relationnal Database Service", "https://www.logicata.com/wp-content/uploads/2020/08/Amazon-RDS@4x.png")}
            {AwsService("Elastic Container Service", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVCr47BYUmjvnT49j1-lrHpe1S6yd5W5mMcA&usqp=CAU")}
