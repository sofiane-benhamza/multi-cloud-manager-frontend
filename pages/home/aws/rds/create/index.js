  ...
  const handleCreateRDS = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setWarning({
          message: "something went wrong, please try again or contact support ... [error code ... 382]",
          type: "danger",
          isShown: true
        })
      ...
      setWarning({
        message: "something went wrong, please try again or contact support ... [error code ... 342]",
        type: "danger",
        isShown: true
      });
      return false
                ...
                <div className="col-12">
                  <form onSubmit={handleCreateRDS}>
                    <h3 className="text-center row mb-5">
                      <div className="col">Create a Relational Database</div>
                      <div className="col-auto">
                        <button className="btn btn-light btn-lg" title="Reset" type="button" onClick={() => { setDisabled(INIT.disabled); setChooseFrom(INIT.chooseFrom); setDatabase(INIT.database) }}>
