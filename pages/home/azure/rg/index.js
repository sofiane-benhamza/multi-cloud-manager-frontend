                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="d-flex flex-row mb-4">
                                ...
                                <button className="border border-dark rounded d-flex align-items-center ml-auto mr-3 px-3 btn btn-light"
                                    onClick={() => {
                                        setFilter((prev) => ({ ...prev, resourceGroups: [{ id: wait, rgName: wait, managedBy: wait }] }));
                                        getResourceGroups(token, filter.account, filter.location, setFilter, true)
