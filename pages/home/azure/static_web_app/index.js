                        ...
                        <div className="card-body">
                            <div className="d-flex flex-row mb-4">
                                ...
                                <button className="border border-dark rounded d-flex align-items-center ml-auto mr-3 px-3 btn btn-light" onClick={() => {
                                    setFilter((prev) => ({ ...prev, webApps: [{ resourceGroup: wait, id: "-", name: wait, hostname: wait, repository: wait }] }));
                                    getWebApps(token, filter.account, filter.location, setFilter)
                                    ...
                                    <tbody>
                                        {filter.webApps.map((webApp, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="text-center" title={webApp.hostname} ><button disabled={webApp.id == "-"} className="btn btn-dark"><a href={"https://" + webApp.hostname} className="bi bi-box-arrow-up-right" target="_blank"></a></button></td>
                                                <td className="text-center" title={webApp.repository} ><button disabled={!webApp.repository} className="btn btn-dark"><a href={webApp.repository} className="bi bi-box-arrow-up-right" target="_blank"></a></button></td>
