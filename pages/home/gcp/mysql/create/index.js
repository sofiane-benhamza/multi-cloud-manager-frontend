...
import { regions, dbSizes, mysqlVersions } from "@/utils/gcp";
...
export default function CreateMySQL({ setWarning, setToken }) {
    ...
    const handleCreateDB = async (e) => {
        ...
        try {
            ...
            setWarning({
                message:
                    "Something went wrong, please try again later or contact support [error : 728]",
                type: "danger",
                isShown: true,
            });
        } finally {
                                ...
                                <div className="col-12">
                                    <form onSubmit={handleCreateDB}>
                                        ...
                                        >
                                            ...
                                            {mysqlVersions.map((version, index) => (
