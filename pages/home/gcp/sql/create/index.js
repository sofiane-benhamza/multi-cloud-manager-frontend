...
import { regions, dbSizes, sqlVersions } from "@/utils/gcp";
...
export default function CreateMySQL({ setWarning, setToken }) {
    ...
    const handleCreateDB = async (e) => {
        ...
        try {
            ...
            dbConfig.append("tier", `db-custom-${db.cpu}-${db.ram}`);

            for (const key in db) {
                if (!["cpu", "ram"].includes(key)) {
                    dbConfig.append(key, db[key])
                    console.warn(!["cpu", "ram"].includes(key), key);
                }
            }
    ...
    return (
        <div className="d-flex align-items-center justify-content-center p-5 tilt-warp-title">
            <div className="justify-content-center align-items-center col-xl-5 col-lg-6 col-md-8 col-sm-10 col-xs-12">
                <div className="w-100 border border-dark rounded mt-3">
                            ...
                            <div className="row justify-content-center d-flex justify-content-center align-items-center">
                                <div className="w-100">
                                    <form onSubmit={handleCreateDB}>
                                        ...
                                        <div>
                                            ...
                                            <div className="d-flex flex-row">
                                                ...
                                                <input
                                                    ...
                                                    min={1}
                                                    max={32}
                                                    title="Allows from 1 to 32 CPUs"
                                                    onChange={handleInputChange}
                                                    value={db.cpu}></input>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label className="form-label">RAM (MBs)</label>
                                            <div className="d-flex flex-row">
                                                <input
                                                    type="range"
                                                    id="cpu"
                                                ...
                                                <input
                                                    ...
                                                    min={3840}
                                                    max={65536}
                                                    onChange={(e) => { setDB((prev) => ({ ...prev, ram: e.target.value })) }} value={db.ram}></input>
                                            </div>
                                            <br />
                                            Tier : db-custom-{db.cpu}-{db.ram}
                                        </div>
                                        <br />
                                        <br />
