...
export default function azure() {
    ...
    const azureServices = [
        { name: "Deploy on a static web app", link: "azure_static_web_app" },
    ...
    return (
        <div className="container">
            ...
            <div className="d-flex row w-100 justify-content-left mx-auto text-dark">            {azureServices.map((service, index) => (
...
const AzureService = ({ name, link }) => {
    let logoUrl = "/cloud/azure/static_web_app"
    return (
