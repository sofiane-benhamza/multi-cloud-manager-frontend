...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Matious Cloud Manager</title>
...
const TypewriterCard = () => {
  return (
    <div className="vw-100 d-flex flex-wrap justify-content-center align-items-center my-5">
      <div className='mt-5 p-5 border-top border-left border-bottom border-dark col-xl-4 col-lg-5 col-md-6 bg-beach'>
        <div className="mb-4">
        ...
        <div className='d-flex justify-content-center mt-3'>
          <span className='btn-beach'>Start&nbsp;using</span>
          <span className='btn-beach'>Learn&nbsp;more</span>
        </div>
      </div>
